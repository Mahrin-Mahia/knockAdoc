<div class="box1">
    <div class="profile-pic">
        ...
        $sql = "SELECT * FROM profile_pics WHERE patient_id = $user_id";
    ...
    if (isset($_POST["submit-image"])) {
      ...
      $imageFileType = strtolower(pathinfo($target_file, PATHINFO_EXTENSION));
        ...
        if ($results->num_rows > 0) {
            $sql = "UPDATE profile_pics SET image_name = '$filename' WHERE patient_id = $user_id ";
        } else {
            $sql = "INSERT INTO profile_pics (patient_id,image_name) VALUES ('$user_id','$filename')";
        }
